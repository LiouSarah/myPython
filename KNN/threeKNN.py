...
n = len(y)
cmap_bold = ['#7B68EE', '#FFA07A','#00A86B']
...
cmap_light = ListedColormap(['#9BDDFF', '#F7E7CE','#90EE90'])
...
plt.title('KNN training error = %.3f for K = %i' % (Knn.trainingError.mean(),K))

# plt.savefig('C:\\Users\\sarah\\OneDrive\\桌面\\satatistic_hw\\XeLaTex\\eps_five\\KNN_3_data2_20.eps', format='eps')
